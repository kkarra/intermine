...
/**
 * A converter/retriever for the LaevisGff dataset via GFF files.
 */

public class LaevisGffGFF3RecordHandler extends GFF3RecordHandler
{

    /**
     * Create a new LaevisGffGFF3RecordHandler for the given data model.
     * @param model the model for which items will be created
     */
    public LaevisGffGFF3RecordHandler (Model model) {
        super(model);
