...
<div align="center" id="headercontainer">
  ...
  <a href="${WEB_PROPERTIES['project.modSitePrefix']}" alt="Home" rel="NOFOLLOW">
    <img id="logo" src="model/images/frog.jpeg" width="98px" height="65px"  alt="Xenbase" />
  </a>
  <h1>
    <html:link href="${WEB_PROPERTIES['project.sitePrefix']}/" styleId="xenmine-logo"></html:link>
  </h1>
