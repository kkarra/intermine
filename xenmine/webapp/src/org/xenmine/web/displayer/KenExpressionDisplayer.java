 ...
 * @author Julie
 */
public class KenExpressionDisplayer extends ReportDisplayer
{

	   private static final org.apache.log4j.Logger LOG = Logger.getLogger(KenExpressionDisplayer.class);
     ...
     * @param im .
     */
    public KenExpressionDisplayer(ReportDisplayerConfig config, InterMineAPI im) {
        super(config, im);
    }
    ...
    public void display(HttpServletRequest request, ReportObject reportObject){
        ...
        if (id != null) {
            ...
            String geneId = String.valueOf(id);
                ...
                request.setAttribute("kenrnaseqResults", results);
                
        } catch (Exception e) {
            request.setAttribute("kenrnaseqResults", new LinkedHashMap<String, String>());
        }
    ...
    private static PathQuery getQuery(String geneId, PathQuery query) {
        ...
        query.addConstraint(Constraints.eq("Gene.expressionScores.experiments.dataset.name", "Ken Cho"));
