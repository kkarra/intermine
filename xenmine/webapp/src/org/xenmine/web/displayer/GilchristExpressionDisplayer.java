 ...
 * @author Julie
 */
public class GilchristExpressionDisplayer extends ReportDisplayer
{

	   private static final org.apache.log4j.Logger LOG = Logger.getLogger(GilchristExpressionDisplayer.class);
     ...
     * @param im .
     */
    public GilchristExpressionDisplayer(ReportDisplayerConfig config, InterMineAPI im) {
        super(config, im);
    }
    ...
    public void display(HttpServletRequest request, ReportObject reportObject){
        ...
        if (id != null) {
            ...
            String geneId = String.valueOf(id);
                ...
                request.setAttribute("gilchristrnaseqResults", results);
                
        } catch (Exception e) {
            request.setAttribute("gilchristrnaseqResults", new LinkedHashMap<String, String>());
        }
    ...
    private static PathQuery getQuery(String geneId, PathQuery query) {
        ...
        query.addConstraint(Constraints.eq("Gene.expressionScores.experiments.dataset.name", "Mike Gilchrist"));
