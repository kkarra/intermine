 ...
 * @author Julie
 */
public class SmithExpressionDisplayer extends ReportDisplayer
{

	   private static final org.apache.log4j.Logger LOG = Logger.getLogger(SmithExpressionDisplayer.class);
     ...
     * @param im .
     */
    public SmithExpressionDisplayer(ReportDisplayerConfig config, InterMineAPI im) {
        super(config, im);
    }
    ...
    public void display(HttpServletRequest request, ReportObject reportObject){
        ...
        if (id != null) {
            ...
            String geneId = String.valueOf(id);
                ...
                request.setAttribute("smithrnaseqResults", results);
                
        } catch (Exception e) {
            request.setAttribute("smithrnaseqResults", new LinkedHashMap<String, String>());
        }
    ...
    private static PathQuery getQuery(String geneId, PathQuery query) {
        ...
        query.addConstraint(Constraints.eq("Gene.expressionScores.experiments.dataset.name", "Jim Smith"));
