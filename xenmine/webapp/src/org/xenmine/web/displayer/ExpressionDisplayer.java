...
public class ExpressionDisplayer extends ReportDisplayer
{
    ...
    public void display(HttpServletRequest request, ReportObject reportObject){
        ...
        if (id != null) {
            ...
            String geneId = String.valueOf(id);
                ...
                request.setAttribute("rnaseqResults", results);
                
        } catch (Exception e) {
            request.setAttribute("rnaseqResults", new LinkedHashMap<String, String>());
        }
    ...
    private static Map<String, String> processResults(ExportResultsIterator it) {
        ...
        while (it.hasNext()) {
            ...
            System.out.println("stage is : " +stage +  "score is .. : "+ expressionScore);
