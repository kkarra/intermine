 ...
 * @author Julie
 */
public class VeenstraExpressionDisplayer extends ReportDisplayer
{

	   private static final org.apache.log4j.Logger LOG = Logger.getLogger(VeenstraExpressionDisplayer.class);
     ...
     * @param im .
     */
    public VeenstraExpressionDisplayer(ReportDisplayerConfig config, InterMineAPI im) {
        super(config, im);
    }
    ...
    public void display(HttpServletRequest request, ReportObject reportObject){
        ...
        if (id != null) {
            ...
            String geneId = String.valueOf(id);
                ...
                request.setAttribute("veenstrarnaseqResults", results);
                
        } catch (Exception e) {
            request.setAttribute("veenstrarnaseqResults", new LinkedHashMap<String, String>());
        }
    ...
    private static PathQuery getQuery(String geneId, PathQuery query) {
        ...
        query.addConstraint(Constraints.eq("Gene.expressionScores.experiments.dataset.name", "Veenstra"));
